...
export default function ConfirmSignupEmail({ username, confirmUrl }: ConfirmSignupEmailProps) {
  return (
    <Html lang="ja">
      <Head />
      <Container style={{ maxWidth: 480, margin: '0 auto', padding: 24, fontFamily: 'sans-serif', background: '#fff', borderRadius: 8, boxShadow: '0 2px 8px #eee' }}>
        <Section>
          ...
          <Button href={confirmUrl} style={{ background: '#2563eb', color: '#fff', padding: '12px 24px', borderRadius: 6, fontSize: 16, fontWeight: 'bold', textDecoration: 'none', display: 'inline-block', margin: '24px 0' }}>
            メールアドレスを確認する
          </Button>
